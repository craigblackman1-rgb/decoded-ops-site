...
Generated from commit `0f90c05`.

**16 flags across 9 files.**
...
| overclaim — Superlative overclaim, only allowed if literally true | 7 |
...
- `components/Header.tsx:16` We're on the wrong software
- `components/Header.tsx:18` Our system is ancient
- `components/Header.tsx:26` We can't take on more work
- `components/Header.tsx:28` Busy season breaks us
- `components/Header.tsx:34` We run the place on spreadsheets
- `components/Header.tsx:37` We don't know what stock we have
...
- `app/blog/[slug]/page.tsx:207` A Clarity Audit maps your actual operations, identifies the changes that will make the biggest difference, and gives you a plan you can act on. No reports you'll never read. No recommendations you can't implement.
...
- `app/problems/wrong-erp-software/page.tsx:126` 01 Selected on demo, not on fit Vendors are excellent at demos. They show you the things the software does well and move quickly past the things it doesn't. Without sector expertise on your side of the table, you're evaluating presentation skills. Sector-specific systems perform differently depending on your decoration mix and order model, so the only fair evaluation is against a written brief that reflects your actual business.
- `app/sectors/teamwear-clubwear/page.tsx:105` ), title: 'Squad-level personalisation data', body: 'Names, numbers, sponsor logos: every kit is a variant of the same product. Systems that treat that as one SKU force manual workarounds on every single order.',
...
| /problems/wrong-erp-software | 5 |
| /case-studies/eternal-fitness | 4 |
| /deliver | 4 |
| /how-i-build | 4 |
...
| /apps | 2 |
| /decoded-method | 2 |
| /locations/fractional-cto/[location] | 2 |
