          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:flex items-center justify-center p-8 rounded-2xl bg-[#023047]">
              <svg viewBox="0 0 280 220" className="w-full max-w-xs" aria-hidden="true">
                ...
                {/* Doc title */}
                <text x="140" y="39" textAnchor="middle" fontSize="10" fontWeight="700" fill="#F8F9FA" fontFamily="Outfit, sans-serif">OPERATIONS AUDIT REPORT</text>
                {/* Lines of text */}
                ...
                <text x="140" y="192" textAnchor="middle" fontSize="18" fill="#023047" fontWeight="800" fontFamily="Outfit, sans-serif">£47,200</text>
                {/* Corner badge */}
                <circle cx="220" cy="26" r="16" fill="#023047" />
                <text x="220" y="22" textAnchor="middle" fontSize="7" fill="#219EBC" fontWeight="700" fontFamily="Outfit, sans-serif">3×</text>
