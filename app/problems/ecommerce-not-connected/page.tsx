...
export default function EcommerceNotConnectedPage() {
  return (
    <ProblemPage
      ...
      causes={[
        {
          title: 'Integration not scoped before platform selection',
          body: 'The eCommerce platform was chosen on features and price — with the integration question answered by both vendors saying "yes, we can integrate". That\'s not a specification. It\'s a conversation starter.',
        },
        {
          title: 'API limitations discovered post-purchase',
          body: 'Many ERP and MIS systems in this sector have API capability that only covers certain modules, certain versions, or certain data types. You find out after the contracts are signed.',
        },
        {
          title: 'Personalisation data structure mismatch',
          body: 'The way personalisation data is captured on the front end rarely matches the way it needs to be structured for production. Bridging that gap requires both systems to be flexible. Often one of them isn\'t.',
        },
        {
          title: 'The wrong platform for the business model',
          body: 'Generic eCommerce platforms weren\'t designed for businesses that decorate, personalise, or produce to order. The data model doesn\'t fit — and that limits what any integration can achieve.',
        },
      ]}
