   ...
   <section className="g-white" data-od-id="plate">
    <div className="wrap">
      <Plate tone="dark" no="DO-ART-405" title="No plan → documented recovery" rev="01" cls="DECODED OPS · ISSUED">
       <NowAfterPlate
        now={[
          'No backup procedure exists',
          'One server failure = business down',
          'Recovery plan: call someone who knows',
          'Every outage is a crisis',
        ]}
        after={[
          'Documented backup and recovery SOPs',
          'Redundancy built into the architecture',
          'Written plan anyone can execute',
          'Outages are handled, not panicked through',
        ]}
       />
      </Plate>
    </div>
