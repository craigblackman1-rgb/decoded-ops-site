   ...
   <section className="g-white" data-od-id="plate">
    <div className="wrap">
     <Plate tone="dark" no="DO-ART-421" title="Generic ERP → decoration-aware layer" rev="01" cls="DECODED OPS · ISSUED">
       <NowAfterPlate
        now={[
          'BOMs tracked in spreadsheets, not the system',
          'Blank vs finished stock: confused or ignored',
          'Artwork lives in email, not on the order',
          'Every decoration method needs its own workaround',
        ]}
        after={[
          'Decoration BOMs modelled properly',
          'Blank-to-finished mapping automated',
          'Artwork attached to order, version-controlled',
          'One system handles print, embroidery, heat-press',
        ]}
       />
     </Plate>
    </div>
