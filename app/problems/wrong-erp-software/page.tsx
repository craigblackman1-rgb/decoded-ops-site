...
export default function WrongERPSoftwarePage() {
  return (
    <ProblemPage
      ...
      causes={[
        {
          title: 'Selected on demo, not on fit',
          body: 'Vendors are excellent at demos. They show you the things the software does well and move quickly past the things it doesn\'t. Without sector expertise on your side of the table, you\'re evaluating presentation skills.',
        },
        {
          title: 'No independent specification written first',
          body: 'A vendor brief — written by someone who understands your business model before you talk to any vendor — changes the selection process entirely. Without it, you\'re being sold to rather than making an informed choice.',
        },
        {
          title: 'Reference sites in a different sector',
          body: 'Generic ERP vendors often have good reference sites in manufacturing or distribution. Those references don\'t tell you how the software performs in a decoration business with mixed methods, variable artwork, and short-run personalisation.',
        },
        {
          title: 'The total cost wasn\'t modelled',
          body: 'Implementation, training, customisation, integration, ongoing support. The total cost of ownership for an ERP is often two to three times the headline licence cost. That comparison rarely happens before selection.',
        },
      ]}
