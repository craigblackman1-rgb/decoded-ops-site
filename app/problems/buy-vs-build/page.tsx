   ...
   <section className="g-white" data-od-id="plate">
    <div className="wrap">
     <Plate tone="dark" no="DO-ART-418" title="False binary → coverage test" rev="02" cls="DECODED OPS · ISSUED">
       <NowAfterPlate
        now={[
          'Buy vs build framed as a straight choice',
          'The gap the platform leaves is never priced',
          'The cost of changing how you work is invisible',
          'Decision based on a sales pitch',
        ]}
        after={[
          'Three questions: coverage, fit, bloat',
          'The gap costed, not assumed away',
          'Change cost priced before you commit',
