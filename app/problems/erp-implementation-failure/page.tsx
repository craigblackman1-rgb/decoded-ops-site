...
export default function ERPImplementationFailurePage() {
  return (
    <ProblemPage
      ...
      causes={[
        {
          title: 'Scoping done by the vendor',
          body: 'When the vendor scopes their own implementation, they scope for the software — not for your business. The gaps only become visible after go-live.',
        },
        {
          title: 'No independent oversight',
          body: 'Without someone in your corner who understands both the sector and the software, there\'s no one to hold the vendor to account when they miss requirements or cut corners.',
        },
        {
          title: 'Data not prepared',
          body: 'Most implementation failures trace back to data quality. Clean data migration is unglamorous work that vendors underprice and businesses underestimate.',
        },
        {
          title: 'Wrong software for the business model',
          body: 'Sometimes the implementation fails because the software was the wrong choice from the start — selected on demo, not on fit.',
        },
      ]}
