      ...
      <section className="g-off">
        <div className="wrap" style={{ maxWidth: 720 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 48 }}>
            ...
            <div>
              <h2 style={sectionH2}>2. Information We Collect</h2>
            ...
            <div>
              <h2 style={sectionH2}>3. How We Use Your Information</h2>
              <p style={bodyText}>
            ...
            {/* 5. Data Sharing */}
            <div>
              <h2 style={sectionH2}>5. How We Share Your Information</h2>
              <p style={bodyText}>
            ...
            {/* 6. Data Retention */}
            <div>
              <h2 style={sectionH2}>6. How Long We Keep Your Data</h2>
              <p style={bodyText}>
            ...
            {/* 11. Contact Us */}
            <div>
              <h2 style={sectionH2}>11. Contact Us</h2>
              <p style={bodyText}>
