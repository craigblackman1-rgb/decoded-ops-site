...
export default function GarmentDecorationPage() {
  return (
    <SectorPage
      ...
      challenges={[
        {
          title: 'Decoration method mix',
          body: 'Running embroidery, screen print, and DTG in the same business means three different production workflows, three different lead times, and three different cost structures — all managed in systems that don\'t account for the difference.',
        },
        {
          title: 'The artwork loop',
          body: 'Artwork sign-off is the single biggest source of delay in most garment decoration businesses. Every manual chase, every email thread, every approval held in someone\'s inbox is time and cost that doesn\'t show up anywhere.',
        },
        {
          title: 'Blank dependency',
          body: 'Your production schedule is hostage to blank availability. Most businesses have no real visibility of incoming stock vs committed orders — until the problem is already in the queue.',
        },
        {
          title: 'eCommerce disconnected from production',
          body: 'Online orders that don\'t automatically flow into the production schedule. Personalisation that requires manual re-entry. Artwork files that arrive separately from the order. All of this is solvable.',
        },
      ]}
      whatIdo={[
