...
export default function SignsGraphicsPage() {
  return (
    <SectorPage
      ...
      challenges={[
        {
          title: 'Survey-to-installation workflow',
          body: 'The job doesn\'t start when the order is placed — it starts with a site survey. Most systems can\'t track a job from survey through design, production, installation, and sign-off as a single connected workflow.',
        },
        {
          title: 'Substrate and finish complexity',
          body: 'The number of variables in a signage job — substrate, finish, size, fixing method, installation requirements — makes job costing genuinely difficult. Manual approaches mean margin leakage on every complex job.',
        },
        {
          title: 'Installation scheduling',
          body: 'Coordinating installation teams, site access, third-party contractors, and delivery of materials is a logistics challenge that most job management systems don\'t handle well.',
        },
        {
          title: 'Artwork and proof management',
          body: 'Client approval of artwork before production is critical in this sector. Managing that process outside of the production system creates delay, rework, and missed deadlines.',
        },
      ]}
      whatIdo={[
