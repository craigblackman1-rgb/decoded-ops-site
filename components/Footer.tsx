    ...
    <footer className="bg-[#023047] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="text-2xl font-semibold block mb-4">
              Decoded<span className="text-[#219EBC]">Ops</span>
            </Link>
            ...
            <div className="mt-6 text-sm text-[#8ECAE6]">
              <div className="mb-1">
                <a href="mailto:craig@decodedops.co.uk" className="hover:text-[#219EBC] transition-colors">craig@decodedops.co.uk</a>
              </div>
              <div>
                <a href="tel:+447735620603" className="hover:text-[#219EBC] transition-colors">07735 620 603</a>
              </div>
            </div>
          </div>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#8ECAE6]/60 mb-4">Services</h3>
            <ul className="space-y-2.5">
              {services.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#8ECAE6] hover:text-[#219EBC] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
            ...
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#8ECAE6]/60 mb-4 mt-8">Company</h3>
            <ul className="space-y-2.5">
              {company.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#8ECAE6] hover:text-[#219EBC] transition-colors">
          ...
          {/* Sectors */}
          <div>
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#8ECAE6]/60 mb-4">Sectors</h3>
            <ul className="space-y-2.5">
              {sectors.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#8ECAE6] hover:text-[#219EBC] transition-colors">
          ...
          {/* Problems */}
          <div>
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#8ECAE6]/60 mb-4">Problems we solve</h3>
            <ul className="space-y-2.5">
              {problems.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#8ECAE6] hover:text-[#219EBC] transition-colors">
        ...
        <div className="border-t border-[#F8F9FA]/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#8ECAE6]/50">© {new Date().getFullYear()} Decoded Ops (CRB Consultancy). All rights reserved.</p>
          <p className="text-xs text-[#8ECAE6]/30">Built with precision and purpose.</p>
        </div>
      </div>
    </footer>
  );
