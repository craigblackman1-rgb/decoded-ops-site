      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-[#93A8C0] leading-relaxed mb-6 max-w-xs">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-[#3A86FF]/20 hover:bg-[#3A86FF] flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
              </a>
            </div>
            <div className="mt-6 text-sm text-[#93A8C0]">
              <div className="mb-1">
                <a href="mailto:craig@decodedops.co.uk" className="hover:text-[#3A86FF] transition-colors">craig@decodedops.co.uk</a>
              </div>
              <div>
                <a href="tel:+447735620603" className="hover:text-[#3A86FF] transition-colors">07735 620 603</a>
              </div>
            </div>
          </div>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#93A8C0]/60 mb-4">Services</h3>
            <ul className="space-y-2.5">
              {services.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#93A8C0] hover:text-[#3A86FF] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
            ...
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#93A8C0]/60 mb-4 mt-8">Company</h3>
            <ul className="space-y-2.5">
              {company.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#93A8C0] hover:text-[#3A86FF] transition-colors">
          ...
          {/* Sectors */}
          <div>
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#93A8C0]/60 mb-4">Sectors</h3>
            <ul className="space-y-2.5">
              {sectors.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#93A8C0] hover:text-[#3A86FF] transition-colors">
          ...
          {/* Problems */}
          <div>
            <h3 className="text-xs font-semibold tracking-widest uppercase text-[#93A8C0]/60 mb-4">Problems we solve</h3>
            <ul className="space-y-2.5">
              {problems.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#93A8C0] hover:text-[#3A86FF] transition-colors">
        ...
        <div className="border-t border-[#F8F9FA]/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#93A8C0]/50">© {new Date().getFullYear()} Decoded Ops (CRB Consultancy). All rights reserved.</p>
          <p className="text-xs text-[#93A8C0]/30">Built with precision and purpose.</p>
        </div>
      </div>
    </footer>
  );
