...
import { fDisp, fBody, fMono, CYAN, AMBER, schematicPalette, SchematicDefs, type Tone } from './primitives';
...
const trackTint = (tone: Tone) => (tone === 'dark' ? 'rgba(142,202,230,0.18)' : 'rgba(2,48,71,0.08)');
...
export function SixSigmaSchematic({ tone = 'dark', className }: { tone?: Tone; className?: string }) {
  ...
  return (
    <svg viewBox="0 0 1240 560" className={className} style={{ width: '100%', height: 'auto' }}
      ...
      <SchematicDefs tone={tone} idPrefix="ss" />
      <defs>
      ...
      {/* track */}
      <rect x="130" y={trackY} width="990" height="10" rx="5" fill={track} />
