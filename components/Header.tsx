...
// ── "What's going wrong" — the old flat Problems list, grouped and in plain English ──
...
const helpBuilt: NavGroup = {
  ...
  items: [{ label: 'Decoded Data App', sub: 'Supplier feeds into one clean catalogue', href: '/decoded-data-app' }],
};
...
// ── "Your industry" — sectors, unchanged from the live nav ──
